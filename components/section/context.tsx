					...
					<div className="p-6 space-y-3">
							...
							<div className="space-y-2">
								{sectionsAbove.map((section) => (
									<button
										...
										className="w-full p-3 text-left rounded-lg hover:bg-teal-500/20 transition-colors text-teal-200/60 hover:text-teal-200 font-offbit cursor-pointer"
									>
						...
						{currentSection && (
							<div className="p-3 bg-teal-500/30 rounded-lg">
								<span className="font-semibold text-teal-200 font-offbit cursor-not-allowed">{currentSection.title}</span>
							</div>
						)}
