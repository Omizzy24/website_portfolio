	...
	return (
		<div
			className={css(
				...
				isLoaded && 'border-2 border-teal-600 [background:linear-gradient(45deg,#0a1f2e,--theme(--color-slate-800)_50%,#0a1f2e)_padding-box,conic-gradient(from_var(--border-angle),--theme(--color-slate-600/.48)_80%,--theme(--color-teal-500)_86%,--theme(--color-teal-300)_90%,--theme(--color-teal-500)_94%,--theme(--color-slate-600/.48))_border-box] rounded-2xl border-transparent animate-border' 
			)}
